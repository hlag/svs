...
class controller
{
    ...
    {
        $navi = array('Liste&status=all' => 'alle', 'Liste&status=1' => 'Vorschlag', 'Liste&status=5' => 'neu', 'Liste&status=2' => 'nächsteProbe', 'Liste&status=repertoire' => 'Repertoire', 'genres' => 'Genres', 'erschienen' => 'erschienen', 'upload' => 'Upload', 'playlist' => 'Playlist');
