//>>built
define("dojox/gauges/_Gauge",["dojo/_base/declare","dojo/_base/lang","dojo/_base/html","dojo/_base/array","dojo/_base/event","dojo/_base/connect","dojo/dom-construct","../../.././_Widget","dojox/gfx","./Range","dojo/fx/easing"],function(_1,_2,_3,_4,_5,_6,_7,_8,_9,_a){
var _b=0;
var _c=0;
...
if(this.useTooltip){
require(["../../.././Tooltip"],dojo.hitch(this,function(_16){
...
if(this.useTooltip){
require(["../../.././Tooltip"],dojo.hitch(this,function(_29){
...
if(this.useTooltip&&!this._drag){
if(_2d.hover){
require(["../../.././Tooltip"],dojo.hitch(this,function(_2e){
_3.style(this.mouseNode,"left",e.pageX+1+"px");
_3.style(this.mouseNode,"top",e.pageY+1+"px");
...
require(["../../.././Tooltip"],dojo.hitch(this,function(_30){
...
_3.style(this.mouseNode,"left",e.pageX+1+"px");
_3.style(this.mouseNode,"top",e.pageY+1+"px");
require(["../../.././Tooltip"],dojo.hitch(this,function(_33){
